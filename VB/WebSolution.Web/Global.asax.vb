...
#If EASYTEST Then
			...
			End If
#End If
			AddHandler DevExpress.Persistent.Base.Tracing.NeedContextInformation, AddressOf Tracing_NeedContextInformation
		...
		End Sub
		Private Shared Sub Tracing_NeedContextInformation(ByVal sender As Object, ByVal e As DevExpress.Persistent.Base.NeedContextInformationEventArgs)
			Dim user As String
			If String.IsNullOrEmpty(SecuritySystem.CurrentUserName) Then
				user = "Unknown"
			Else
				user = SecuritySystem.CurrentUserName
			End If
			Dim host As String
			If String.IsNullOrEmpty(HttpContext.Current.Request.UserHostAddress) Then
				host = "Unknown"
			Else
